...
def save_message_and_notify(conversation_id, direction, sender_type,
    ...
    # Se utiliza esta función para evitar duplicación de lógica entre la recepción de mensajes
    # desde el webhook de WhatsApp y el envío de mensajes desde la API. Así, cualquier cambio
    # en el flujo de guardado y notificación se realiza en un solo lugar, facilitando el mantenimiento.
    ...
    # GLOSARIO
    # ============================================================================
    # - Serialización: Proceso de convertir objetos Python (o documentos MongoDB) a formatos compatibles con JSON para APIs.
    # - Webhook: Punto de entrada HTTP que recibe eventos externos (ej: mensajes de WhatsApp).
    # - Socket.IO: Biblioteca para comunicación en tiempo real entre servidor y clientes web.
    # - Recursión: Técnica donde una función se llama a sí misma para resolver problemas anidados.
    # - Comprehension: Sintaxis compacta para crear listas o dicts a partir de iteraciones.
    # - API REST: Interfaz que permite la comunicación entre sistemas usando HTTP y recursos identificados por URLs.
    # - 404: Código de estado HTTP que indica que un recurso no fue encontrado.

    # ============================================================================
    # BUENAS PRÁCTICAS Y RECOMENDACIONES
    # ============================================================================
    # - Centralizar lógica repetida en funciones utilitarias para facilitar el mantenimiento.
    # - Documentar cada función con docstrings claros y ejemplos de uso si es posible.
    # - Usar nombres descriptivos para funciones y variables, reflejando su propósito.
    # - Manejar errores y casos no encontrados de forma explícita (ej: get_or_404).
    # - Seguir la convención PEP 8 para estilo y legibilidad en Python.
    # - Comentar decisiones de diseño o flujos complejos para futuros desarrolladores.
